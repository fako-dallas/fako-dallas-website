      ...
      <div className="w-full px-4">
        <div className="mx-auto max-w-[800px] text-center">
          ...
          <p className="mb-12 text-base leading-relaxed text-white sm:text-lg md:text-xl">
            FakoDallas is a vibrant community of artists, creators, and enthusiasts dedicated to exploring the world of digital art and creativity. Join us to connect, share, and discover the endless possibilities of artistic expression in the digital realm.
          </p>
...
const Decor = () => {
  return <div>  <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          <svg
            width="450"
            height="556"
            viewBox="0 0 450 556"
